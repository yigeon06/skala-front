    ...
    try {
        weatherResult.innerHTML = `
            <div class="weather-info">
                <strong>📍 ${name}</strong>
                <p style="font-size: 12px; color: #8e8e8e; margin: 4px 0 0 0;">위도: ${lat} | 경도: ${lon}</p>
        ...
        weatherResult.innerHTML = `
            <div class="weather-info" style="animation: fadeInUp 0.4s ease-out forwards; text-align: left;">
                <strong style="display: block; font-size: 14px; color: #080808; margin-bottom: 2px;">📍 ${name}</strong>
